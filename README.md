...
<img src="logo.png" alt="ZNeko Link Logo" width="200" height="200" />
...
You do not need to use every feature. ZNeko Link can also be used simply for wireless ROM transfers, manual file synchronization, backups, or emulator preset management.
...
3. Once selected, ZNeko Link will automatically manage the following structure inside that folder:
   ...
   - `emu-presets/`: Stores shareable JSON emulator configurations.
